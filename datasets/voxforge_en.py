...
class VoxForge_En(DatasetParser):
    ...
    def __init__(self, dataset_dir=None, name='voxforge_en', **kwargs):

        dataset_dir = dataset_dir or 'data/voxforge_en'

        super(VoxForge_En, self).__init__(dataset_dir, name, **kwargs)
